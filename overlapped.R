...
# from outside files
marker_overlap <- marker[marker %in% res$marker]
...
pbmc <- RunPCA(object = pbmc, features = marker_overlap)
...
ARI(seurat_clusters, train_col_index) #0.4650592
